<?php
 ...
 require_once('../PHPMailer/EncrptyModel.php');
    ...
    if($valMail=mysqli_fetch_array($queryMail)){ 
        ...
        $queryupdate=mysqli_query($con,"UPDATE meddolic_user_details SET password='$encLogPass' WHERE member_id='$member_id'");
        
        require_once "../PHPMailer/PHPMailer.php";
        require_once "../PHPMailer/SMTP.php";
        require_once "../PHPMailer/Exception.php";
        require_once "../PHPMailer/OAuthCredential.php";
        $mailSubject="Wealthy Crowd  Login Password Recover";
        $newMsg='      <html>
  <head>
  ...
  <body>
    <div style="background-color: #f2f2f2; padding: 20px;">
      ...
      <ul>
        ...
        <li>Login Password: <em>'.$loginPassword.'</em></li>
      </ul>
