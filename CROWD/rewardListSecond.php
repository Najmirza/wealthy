            ...
            <div class="row">
                <div class="col-lg-5 col-md-8 col-sm-12">                        
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"> Reward  Archiever List</li>
                    </ul>
                </div>            
            </div>
        </div>
...
var d = document.getElementById("Members");
    d.className += " active";
var d = document.getElementById("rewardListSecond");
    d.className += " active";
</script>
</body>
</html> 