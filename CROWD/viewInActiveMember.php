        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-5 col-md-8 col-sm-12">                        
                    <h2><a href="javascript:void(0);" onclick="window.history.back();" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> View In Active Member</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="dashboard"><i class="icon-home"></i></a></li>
                        <li class="breadcrumb-item"> Member </li>
                        <li class="breadcrumb-item active"> View In Active Member</li>
                    </ul>
                </div>            
            </div>
        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover dataTable js-exportable table-custom mb-0">
                                ...
                                <?php 
                                    ...
                                    $count=0;
                                    $queryUser=mysqli_query($con,"SELECT a.user_id,a.name,a.phone,a.member_id,a.account_status,a.password,a.date_time,b.user_id AS sponserId,b.name AS sponserName FROM meddolic_user_details a, meddolic_user_details b WHERE CAST(a.date_time AS DATE) BETWEEN '$cal_date' AND '$cal_date1' AND a.member_id!=1 AND a.user_type=2 AND a.sponser_id=b.member_id AND a.topup_flag=0 ".$query." order by a.date_time DESC");
