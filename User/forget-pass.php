...
<head>
    ...
    <title>Wealthy Crowd|| Password Recovery</title>
                  ...
                  <div class="card account-card text-center gradient-border" id="box">
                      <div class="card-body">
                        <div class="col-md-12 text-center pb-2">
                           <a href="http://cygnetglobal.io"><span class="text-white txt font-weight-bolder"> Home |</span></a><a id="btnForgotPassword" href="../User" class="reset-password txt text-white font-weight-bolder"> Sign In</a>
                        </div>
