<?php
    ...
    if($valDetails=mysqli_fetch_array($queryDetails)){
        ...
        $password=trnPassword (6);
   
        $passObj= new passEncrypt();
        $encLogPass= $passObj -> twoPassEncrypt($password);
  
        $queryupdate=mysqli_query($con,"UPDATE meddolic_user_details SET password='$encLogPass' WHERE member_id='$memberId'");
        ...
        $mailSubject="Wealthy Crowd Password Recover";
        $newMsg=' <html>
  <head>
    <title>Login Password Recovery - Wealthy Crowd</title>
    <link href="https://svc.webspellchecker.net/spellcheck31/lf/scayt3/ckscayt/css/wsc.css" rel="stylesheet" type="text/css" />
  </head>
  <body>
    <div style="background-color: #f2f2f2; padding: 20px;">
      <h1>Login Password Recovery - Wealthy Crowd</h1>
      <p>Dear <strong>'.$name.'</strong>,</p>
      <p>Greetings from Wealthy Crowd! We received your request to recover your login password for your Wealthy Crowd account. We understand the importance of accessing your account and are here to assist you.</p>
      <ul>
