...
<h4 class="fw-bold py-3 mb-4"> Level Income</h4>
              ...
              <?php 
               ...
               while($valLevel=mysqli_fetch_assoc($queryLevel)){
                ...
                <tr>
                  ...
                  <td><span class="badge badge-success"><i class="fa-solid fa-dollar"></i> <?= $valLevel['levelIncome']?></span></td>
